...
type ListPackagesRequest struct {
	...
	// The absolute path to the root of the user's project. If no registries are provided, this should be populated to provide more context about the user's project.
	// If registries is empty and this is not populated, the CWD is used.
	ProjectRoot   *string `protobuf:"bytes,2,opt,name=project_root,proto3,oneof" json:"project_root,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
const file_skiff_cmd_v1alpha1_commands_proto_rawDesc = "" +
	...
	"\bpackages\x18\x01 \x03(\v2 .skiff.registry.v1alpha1.PackageR\bpackages\"o\n" +
	"\x13ListPackagesRequest\x12\x1e\n" +
	"\n" +
	"registries\x18\x01 \x03(\tR\n" +
	"registries\x12'\n" +
	"\fproject_root\x18\x02 \x01(\tH\x00R\fproject_root\x88\x01\x01B\x0f\n" +
	"\r_project_root\"\x86\x02\n" +
