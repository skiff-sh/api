...
// Validate checks the field values on PackagePermissions with the rules
// defined in the proto definition for this message. If any rules are
// violated, the first error encountered is returned, or nil if there are no violations.
func (m *PackagePermissions) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on PackagePermissions with the rules
// defined in the proto definition for this message. If any rules are
// violated, the result is a list of violation errors wrapped in
// PackagePermissionsMultiError, or nil if none found.
func (m *PackagePermissions) ValidateAll() error {
	return m.validate(true)
}

func (m *PackagePermissions) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return PackagePermissionsMultiError(errors)
	}

	return nil
}

// PackagePermissionsMultiError is an error wrapping multiple validation errors
// returned by PackagePermissions.ValidateAll() if the designated constraints
// aren't met.
type PackagePermissionsMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m PackagePermissionsMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m PackagePermissionsMultiError) AllErrors() []error { return m }

// PackagePermissionsValidationError is the validation error returned by
// PackagePermissions.Validate if the designated constraints aren't met.
type PackagePermissionsValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e PackagePermissionsValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e PackagePermissionsValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e PackagePermissionsValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e PackagePermissionsValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e PackagePermissionsValidationError) ErrorName() string {
	return "PackagePermissionsValidationError"
}

// Error satisfies the builtin error interface
func (e PackagePermissionsValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
	...
	return fmt.Sprintf(
		"invalid %sPackagePermissions.%s: %s%s",
		key,
		e.field,
		e.reason,
		cause)
...
var _ error = PackagePermissionsValidationError{}
...
var _ interface {
	...
	Cause() error
	ErrorName() string
} = PackagePermissionsValidationError{}
...
// Validate checks the field values on File_Source with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *File_Source) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on File_Source with the rules defined in
// the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in File_SourceMultiError, or
// nil if none found.
func (m *File_Source) ValidateAll() error {
	return m.validate(true)
}

func (m *File_Source) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if len(errors) > 0 {
		return File_SourceMultiError(errors)
	}

	return nil
}

// File_SourceMultiError is an error wrapping multiple validation errors
// returned by File_Source.ValidateAll() if the designated constraints aren't met.
type File_SourceMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m File_SourceMultiError) Error() string {
	msgs := make([]string, 0, len(m))
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m File_SourceMultiError) AllErrors() []error { return m }

// File_SourceValidationError is the validation error returned by
// File_Source.Validate if the designated constraints aren't met.
type File_SourceValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e File_SourceValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e File_SourceValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e File_SourceValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e File_SourceValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e File_SourceValidationError) ErrorName() string { return "File_SourceValidationError" }

// Error satisfies the builtin error interface
func (e File_SourceValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = File_SourceValidationError{}
